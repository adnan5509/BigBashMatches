...
public class BatchConfig {
    ...
    private final String[] MATCH_INPUT_FIELDS = new String[] { "id", "city", "date", "player_of_match", "venue",
    ...
    public FlatFileItemReader<MatchInput> reader() {
        return new FlatFileItemReaderBuilder<MatchInput>()
                ...
                .resource(new ClassPathResource("bbl-matches.csv"))
                .delimited()
                .names(MATCH_INPUT_FIELDS)
